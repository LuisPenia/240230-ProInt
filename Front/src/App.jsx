...
[
  ...
  { id:2,name:'Bombero infantil',price:19.75,mainCategory:'Niños',subCategory:'Oficios',imageUrl:'https://m.media-amazon.com/images/I/81F8WH2Oy-L._AC_SX569_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'M',description:'Mono de trabajo resistente al fuego, cas',largeDescription:'Mono de trabajo resistente al fuego, casco y herramientas'},
  ...
  { id:4,name:'Arlequin adulto',price:32.47,mainCategory:'Mujer',subCategory:'Comic',imageUrl:'https://m.media-amazon.com/images/I/61rkb1JXfoL._AC_SL1470_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'S',description:'Mono de cuerpo entero negro y rojo decor',largeDescription:'Mono de cuerpo entero negro y rojo decorado con rombos, volante rojo en el huello y antifaz negro.'},
  ...
  { id:6,name:'Maléfica adulto',price:64.53,mainCategory:'Mujer',subCategory:'Cuento de hadas',imageUrl:'https://m.media-amazon.com/images/I/81aNvdNWr0L._AC_SY879_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'M',description:'Vestido con broche desmontable y tocado ',largeDescription:'Vestido con broche desmontable y tocado de personaje'},
  { id:7,name:'Elvis adulto',price:84.36,mainCategory:'Hombre',subCategory:'Personaje histórico',imageUrl:'https://m.media-amazon.com/images/I/71s9MApCJNL._AC_SX679_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'S',description:'Mono blanco con gliter dorado, estrellas',largeDescription:'Mono blanco con gliter dorado, estrellas y pedrería impresa'},
  { id:8,name:'Dinosaurio infantil',price:34.40,mainCategory:'Niños',subCategory:'Animal',imageUrl:'https://m.media-amazon.com/images/I/51wckD-VogL._AC_SX679_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'L',description:'Mono cómodo para niños pequeños, adaptab',largeDescription:'Mono cómodo para niños pequeños, adaptable con la edad, de franela de alta calidad.'},
  { id:9,name:'Chuky mascota',price:17.69,mainCategory:'Mascotas',subCategory:'Hallowen',imageUrl:'https://m.media-amazon.com/images/I/61j5cIUdZxL.__AC_SY300_SX300_QL70_ML2_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'M',description:'Hecho de algodón transpirable, suave y a',largeDescription:'Hecho de algodón transpirable, suave y amigable para la piel y fibra de poliéster, para la mascota.'},
  { id:10,name:'Murciélago mascota',price:21.36,mainCategory:'Mascotas',subCategory:'Hallowen',imageUrl:'https://m.media-amazon.com/images/I/61-nzdIJKRL._AC_SX679_.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'S',description:'Alas de muerciélago para mascota, con co',largeDescription:'Alas de muerciélago para mascota, con correa y cascabel de calabaza'},
  { id:11,name:'Princesa Ogro adulto',price:22.00,mainCategory:'Mujer',subCategory:'Cuento de hadas',imageUrl:'https://res.cloudinary.com/daawucxot/image/upload/v1715787266/disfraz-de-princesa-ogro.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'XL',description:'Vestido verde de estilo medieval para mu',largeDescription:'Vestido verde de estilo medieval para mujer.Incluye vestido y diadema con Orejas.Corona NO incluida.'},
  { id:12,name:'Galo Obelix deluxe adulto',price:25.75,mainCategory:'Niños',subCategory:'Personaje ficción',imageUrl:'https://res.cloudinary.com/daawucxot/image/upload/v1715787265/disfraz-de-obelix-infantil.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'M',description:'Pantalon rayado con cinturon verde y cam',largeDescription:'Pantalon rayado con cinturon verde y camiseta simil piel. Casco incluido'},
  ...
  { id:17,name:'Fontanero Mario Bros adulto',price:20.80,mainCategory:'Hombre',subCategory:'Personaje ficción',imageUrl:'https://res.cloudinary.com/daawucxot/image/upload/v1715787264/disfraz-de-mario_bros.jpg',imageURL_2:'',imageURL_3:'',imageURL_4:'',size:'XL',description:'Jardinero en azul y camiseta roja. Inclu',largeDescription:'Jardinero en azul y camiseta roja. Incluye buzo y gorra.'},
